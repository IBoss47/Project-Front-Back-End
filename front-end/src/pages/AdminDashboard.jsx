  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 pt-24 pb-16">
       <div className="container mx-auto px-4 mb-4">
              <Link to="/" className="inline-flex items-center text-gray-300 
                  hover:text-white font-semibold text-lg group">
                  <ArrowLeftIcon className="mr-2 h-5 w-5 group-hover:-translate-x-2 
